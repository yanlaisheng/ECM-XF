...
//W25QXX使能
#define SPI_W25QXX_CS_ON HAL_GPIO_WritePin(_W25QXX_CS_GPIO, _W25QXX_CS_PIN, GPIO_PIN_RESET) //SPI_W25QXX使能
#define SPI_W25QXX_CS_OFF HAL_GPIO_WritePin(_W25QXX_CS_GPIO, _W25QXX_CS_PIN, GPIO_PIN_SET)	//SPI_W25QXX禁止使能
